...
import org.apache.httpcopy.params.CoreProtocolPNames;
...
public class RequestExpectContinue implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        if (!request.containsHeader(org.apache.httpcopy.protocol.HTTP.EXPECT_DIRECTIVE)) {
            if (request instanceof HttpEntityEnclosingRequest) {
                ...
                if (entity != null
                    ...
                    if (active) {
                        request.addHeader(org.apache.httpcopy.protocol.HTTP.EXPECT_DIRECTIVE, org.apache.httpcopy.protocol.HTTP.EXPECT_CONTINUE);
                    }
                }
            }
        }
