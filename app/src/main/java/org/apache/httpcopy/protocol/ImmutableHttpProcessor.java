...
public final class ImmutableHttpProcessor implements HttpProcessor {
    ...
    @Deprecated
    public ImmutableHttpProcessor(
            final org.apache.httpcopy.protocol.HttpRequestInterceptorList requestInterceptors,
            final org.apache.httpcopy.protocol.HttpResponseInterceptorList responseInterceptors) {
        super();
        if (requestInterceptors != null) {
