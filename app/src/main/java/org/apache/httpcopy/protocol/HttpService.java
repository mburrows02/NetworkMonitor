...
import org.apache.httpcopy.ConnectionReuseStrategy;
...
import org.apache.httpcopy.HttpServerConnection;
import org.apache.httpcopy.HttpStatus;
import org.apache.httpcopy.HttpVersion;
import org.apache.httpcopy.MethodNotSupportedException;
import org.apache.httpcopy.ProtocolException;
import org.apache.httpcopy.UnsupportedHttpVersionException;
import org.apache.httpcopy.annotation.Immutable;
import org.apache.httpcopy.entity.ByteArrayEntity;
import org.apache.httpcopy.impl.DefaultConnectionReuseStrategy;
import org.apache.httpcopy.impl.DefaultHttpResponseFactory;
import org.apache.httpcopy.params.HttpParams;
import org.apache.httpcopy.util.Args;
import org.apache.httpcopy.util.EncodingUtils;
import org.apache.httpcopy.util.EntityUtils;
 ...
 * individual {@link org.apache.httpcopy.protocol.HttpRequestHandler}s are expected to implement
 ...
 * request.
 * <p>
 * {@code HttpService} can use optional {@link org.apache.httpcopy.protocol.HttpExpectationVerifier}
...
public class HttpService {
    ...
    private volatile org.apache.httpcopy.protocol.HttpExpectationVerifier expectationVerifier = null;
     ...
     *   HttpResponseFactory, HttpRequestHandlerMapper, org.apache.httpcopy.protocol.HttpExpectationVerifier)}
     */
    @Deprecated
    public HttpService(
            ...
            final org.apache.httpcopy.protocol.HttpRequestHandlerResolver handlerResolver,
            final org.apache.httpcopy.protocol.HttpExpectationVerifier expectationVerifier,
     ...
     *  ConnectionReuseStrategy, HttpResponseFactory, org.apache.httpcopy.protocol.HttpRequestHandlerResolver, HttpParams)}
     */
    @Deprecated
    public HttpService(
    ...
    /**
     * @deprecated (4.1) set {@link org.apache.httpcopy.protocol.HttpRequestHandlerResolver} using constructor
     */
    @Deprecated
    public void setHandlerResolver(final org.apache.httpcopy.protocol.HttpRequestHandlerResolver handlerResolver) {
        this.handlerMapper = new HttpRequestHandlerResolverAdapter(handlerResolver);
    }

    /**
     * @deprecated (4.1) set {@link org.apache.httpcopy.protocol.HttpExpectationVerifier} using constructor
     */
    @Deprecated
    public void setExpectationVerifier(final org.apache.httpcopy.protocol.HttpExpectationVerifier expectationVerifier) {
        this.expectationVerifier = expectationVerifier;
    }
    ...
    public void handleRequest(
            ...
            final org.apache.httpcopy.protocol.HttpContext context) throws IOException, HttpException {
     ...
     * {@link org.apache.httpcopy.protocol.HttpRequestHandler} for the request URI of the given request
     * and, if found, executes its
     * {@link org.apache.httpcopy.protocol.HttpRequestHandler#handle(HttpRequest, HttpResponse, org.apache.httpcopy.protocol.HttpContext)}
     * method.
     * <p>
    ...
    protected void doService(
            ...
            final org.apache.httpcopy.protocol.HttpContext context) throws HttpException, IOException {
        org.apache.httpcopy.protocol.HttpRequestHandler handler = null;
    ...
    private static class HttpRequestHandlerResolverAdapter implements HttpRequestHandlerMapper {
        ...
        private final org.apache.httpcopy.protocol.HttpRequestHandlerResolver resolver;

        public HttpRequestHandlerResolverAdapter(final org.apache.httpcopy.protocol.HttpRequestHandlerResolver resolver) {
            this.resolver = resolver;
        }

        @Override
        public org.apache.httpcopy.protocol.HttpRequestHandler lookup(final HttpRequest request) {
