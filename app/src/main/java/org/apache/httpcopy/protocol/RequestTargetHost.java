...
public class RequestTargetHost implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        if (!request.containsHeader(org.apache.httpcopy.protocol.HTTP.TARGET_HOST)) {
            ...
            request.addHeader(org.apache.httpcopy.protocol.HTTP.TARGET_HOST, targethost.toHostString());
        }
    }
