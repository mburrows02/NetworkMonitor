...
public class RequestConnControl implements HttpRequestInterceptor {
    ...
    public void process(final HttpRequest request, final HttpContext context)
        ...
        if (!request.containsHeader(org.apache.httpcopy.protocol.HTTP.CONN_DIRECTIVE)) {
            // Default policy is to keep connection alive
            // whenever possible
            request.addHeader(org.apache.httpcopy.protocol.HTTP.CONN_DIRECTIVE, org.apache.httpcopy.protocol.HTTP.CONN_KEEP_ALIVE);
        }
    }
