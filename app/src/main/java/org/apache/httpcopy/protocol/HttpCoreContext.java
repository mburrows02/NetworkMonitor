...
public class HttpCoreContext implements HttpContext {
    ...
    /**
     * Attribute name of a {@link org.apache.httpcopy.HttpConnection} object that
     * represents the actual HTTP connection.
     */
    public static final String HTTP_CONNECTION  = "http.connection";

    /**
     * Attribute name of a {@link org.apache.httpcopy.HttpRequest} object that
     * represents the actual HTTP request.
     */
    public static final String HTTP_REQUEST     = "http.request";

    /**
     * Attribute name of a {@link org.apache.httpcopy.HttpResponse} object that
     * represents the actual HTTP response.
     */
    public static final String HTTP_RESPONSE    = "http.response";

    /**
     * Attribute name of a {@link org.apache.httpcopy.HttpHost} object that
    ...
    public static HttpCoreContext create() {
        return new HttpCoreContext(new org.apache.httpcopy.protocol.BasicHttpContext());
    }
    ...
    public HttpCoreContext() {
        super();
        this.context = new org.apache.httpcopy.protocol.BasicHttpContext();
    }
