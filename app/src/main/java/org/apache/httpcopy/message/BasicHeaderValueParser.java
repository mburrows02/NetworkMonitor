...
import org.apache.httpcopy.HeaderElement;
import org.apache.httpcopy.NameValuePair;
 ...
 */
@Immutable
public class BasicHeaderValueParser implements org.apache.httpcopy.message.HeaderValueParser {
    ...
    public static
        HeaderElement[] parseElements(final String value,
                                      final org.apache.httpcopy.message.HeaderValueParser parser) throws ParseException {
    ...
    public NameValuePair parseNameValuePair(final CharArrayBuffer buffer,
        ...
        if (cursor.atEnd()) {
            return new org.apache.httpcopy.message.BasicNameValuePair(name, null);
        }
    ...
    protected NameValuePair createNameValuePair(final String name, final String value) {
        return new org.apache.httpcopy.message.BasicNameValuePair(name, value);
    }
