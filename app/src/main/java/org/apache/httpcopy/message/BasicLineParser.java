...
package org.apache.httpcopy.message;

import org.apache.httpcopy.Header;
import org.apache.httpcopy.HttpVersion;
import org.apache.httpcopy.ParseException;
import org.apache.httpcopy.ProtocolVersion;
import org.apache.httpcopy.RequestLine;
import org.apache.httpcopy.StatusLine;
...
import org.apache.httpcopy.util.CharArrayBuffer;
 ...
 */
@Immutable
public class BasicLineParser implements org.apache.httpcopy.message.LineParser {
    ...
    public static
        ProtocolVersion parseProtocolVersion(final String value,
                                             final org.apache.httpcopy.message.LineParser parser) throws ParseException {
        Args.notNull(value, "Value");

        final CharArrayBuffer buffer = new CharArrayBuffer(value.length());
        buffer.append(value);
        final org.apache.httpcopy.message.ParserCursor cursor = new org.apache.httpcopy.message.ParserCursor(0, value.length());
    ...
    public ProtocolVersion parseProtocolVersion(final CharArrayBuffer buffer,
                                                final org.apache.httpcopy.message.ParserCursor cursor) throws ParseException {
    ...
    public boolean hasProtocolVersion(final CharArrayBuffer buffer,
                                      final org.apache.httpcopy.message.ParserCursor cursor) {
        Args.notNull(buffer, "Char array buffer");
        Args.notNull(cursor, "Parser cursor");
    ...
    protected StatusLine createStatusLine(final ProtocolVersion ver,
                                          final int status,
                                          final String reason) {
        return new org.apache.httpcopy.message.BasicStatusLine(ver, status, reason);
    }
    ...
    public Header parseHeader(final CharArrayBuffer buffer)
        ...
        return new org.apache.httpcopy.message.BufferedHeader(buffer);
    }
     ...
     */
    protected void skipWhitespace(final CharArrayBuffer buffer, final org.apache.httpcopy.message.ParserCursor cursor) {
