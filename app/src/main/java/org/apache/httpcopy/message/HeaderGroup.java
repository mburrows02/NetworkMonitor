...
public class HeaderGroup implements Cloneable, Serializable {
    ...
    public HeaderIterator iterator() {
        return new org.apache.httpcopy.message.BasicListHeaderIterator(this.headers, null);
    }
    ...
    public HeaderIterator iterator(final String name) {
        return new org.apache.httpcopy.message.BasicListHeaderIterator(this.headers, name);
    }
