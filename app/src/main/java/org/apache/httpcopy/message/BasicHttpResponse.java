...
import org.apache.httpcopy.ReasonPhraseCatalog;
 ...
 *
 * @see org.apache.httpcopy.impl.DefaultHttpResponseFactory
 *
 * @since 4.0
 */
@NotThreadSafe
public class BasicHttpResponse extends AbstractHttpMessage implements HttpResponse {
    ...
    public StatusLine getStatusLine() {
        if (this.statusline == null) {
            this.statusline = new org.apache.httpcopy.message.BasicStatusLine(
