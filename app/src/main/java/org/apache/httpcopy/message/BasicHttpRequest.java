...
public class BasicHttpRequest extends AbstractHttpMessage implements HttpRequest {
    ...
    public BasicHttpRequest(final String method, final String uri, final ProtocolVersion ver) {
        this(new org.apache.httpcopy.message.BasicRequestLine(method, uri, ver));
    }
    ...
    public RequestLine getRequestLine() {
        if (this.requestline == null) {
            this.requestline = new org.apache.httpcopy.message.BasicRequestLine(this.method, this.uri, HttpVersion.HTTP_1_1);
        }
