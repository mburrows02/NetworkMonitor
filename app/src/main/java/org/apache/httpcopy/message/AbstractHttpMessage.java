...
import org.apache.httpcopy.params.BasicHttpParams;
...
public abstract class AbstractHttpMessage implements HttpMessage {
    ...
    public void addHeader(final String name, final String value) {
        ...
        this.headergroup.addHeader(new org.apache.httpcopy.message.BasicHeader(name, value));
    }
    ...
    public void setHeader(final String name, final String value) {
        Args.notNull(name, "Header name");
        this.headergroup.updateHeader(new org.apache.httpcopy.message.BasicHeader(name, value));
    }
