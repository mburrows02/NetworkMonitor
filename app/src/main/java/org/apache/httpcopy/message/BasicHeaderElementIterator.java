...
import org.apache.httpcopy.FormattedHeader;
import org.apache.httpcopy.Header;
import org.apache.httpcopy.HeaderElement;
import org.apache.httpcopy.HeaderElementIterator;
import org.apache.httpcopy.HeaderIterator;
...
public class BasicHeaderElementIterator implements HeaderElementIterator {
    ...
    private org.apache.httpcopy.message.ParserCursor cursor = null;
    ...
    public BasicHeaderElementIterator(final HeaderIterator headerIterator) {
        this(headerIterator, org.apache.httpcopy.message.BasicHeaderValueParser.INSTANCE);
    }
    ...
    private void bufferHeaderValue() {
        ...
        while (this.headerIt.hasNext()) {
            ...
            if (h instanceof FormattedHeader) {
                ...
                this.cursor = new org.apache.httpcopy.message.ParserCursor(0, this.buffer.length());
