...
public interface HttpResponse extends HttpMessage {
     ...
     */
    org.apache.httpcopy.HttpEntity getEntity();

    /**
     * Associates a response entity with this response.
     * <p>
     * Please note that if an entity has already been set for this response and it depends on
     * an input stream ({@link org.apache.httpcopy.HttpEntity#isStreaming()} returns {@code true}),
     ...
     *                  {@code null} to unset
     *
     * @see org.apache.httpcopy.HttpEntity#isStreaming()
     * @see org.apache.httpcopy.util.EntityUtils#updateEntity(HttpResponse, org.apache.httpcopy.HttpEntity)
     */
    void setEntity(org.apache.httpcopy.HttpEntity entity);
